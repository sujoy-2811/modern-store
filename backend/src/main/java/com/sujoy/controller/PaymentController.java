...
import com.sujoy.repository.OrderRepository;
import com.sujoy.response.ApiResponse;
import com.sujoy.response.PaymentLinkResponse;
import com.sujoy.service.OrderService;
import com.sujoy.service.UserService;
import com.sujoy.user.domain.OrderStatus;
...
public class PaymentController {
	...
	public ResponseEntity<ApiResponse> redirect(@RequestParam(name = "payment_id") String paymentId,
		...
		try {
			...
			new RedirectView("https://shopwithsujoy.vercel.app/payment/failed");
			throw new RazorpayException(e.getMessage());
		}
